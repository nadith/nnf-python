...
class Params(object):
    ...
    def inmem_iterparams():
        ...
        iter_params = {'class_mode': 'categorical',
                       ...
                       'input_shape': (224, 224, 3),  # or 'input_shape': (224, 224),
                       'in_mem': True}
...
class TestVGG16Model(object):
    ...
    def Test_preloaded_db(self):
        ...
        nnf = NNFramework.init(VGG16PatchGen())
        ...
        vggcfg.load_weights_dir = r'E:\SAVED_MODELS'
    ...
    def Test(self):
        ...
        # Initialize the Framework
        nnf = NNFramework.init(VGG16PatchGen(), list_dbparams)

        vggcfg = VGG16Cfg()

        # To save the model & weights
        # vggcfg.save_models_dir = model_folder

        # To save the weights only
        # vggcfg.save_weights_dir = model_folder

        # To load the weights only
        vggcfg.load_weights_dir = r'E:\SAVED_MODELS'

        vggcfg.numepochs = 1
        vggcfg.validation_steps = 1  #800
        vggcfg.steps_per_epoch = 1 #5 #600
        vggcfg.callbacks = [TensorBoardEx(log_dir='D:\\TF\\CNN')]

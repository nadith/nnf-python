...
class CNNPatch(NNPatch):
    ...
    def _generate_nnmodels(self, nnpatch):
        ...
        iter_pp_params = {'rescale': 1. / 255, 'normalize_vgg16': True},

        # iter_params = Params.inmem_iterparams_wnd(self.window_iter)
        # iter_pp_params = {'rescale': 1. / 255, 'normalize_vgg16': True, 'wnd_featurewise_0_1': True}  # 'wnd_max_normalize': True

        return VGG16Model(callbacks={'predict':fn_predict}, iter_params=iter_params, iter_pp_params=iter_pp_params)
...
if __name__ == "__main__":
    ...
    # load the vgg16model (weights only)
